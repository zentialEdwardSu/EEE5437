...
/**
 * Wrapper for fopen that handles differences between MSVC and other platforms;
 * this is used by the project code to read and write files, and is tested by
 * the project test suite to ensure that file I/O works correctly on all
 * platforms.
 */
